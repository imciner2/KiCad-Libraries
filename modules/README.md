...
| SOIC_* | SOIC footprints, named using the library naming convention | |
| SOT_* | SOT footprints (3, 5, 6 pins) | |
| SSOP_* | SSOP footprints, named using the library naming convention | |
